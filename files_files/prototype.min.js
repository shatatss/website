...
"mouseenter"||t==="mouseleave")A=function(x){u.extend(x,k);for(var z=x.relatedTarget;z&&z!==k;)try{z=z.parentNode}catch(F){z=k}z!==k&&r.call(k,x)}}else A=function(x){u.extend(x,k);r.call(k,x)};A.handler=r;w.push(A);return A}function c(){for(var k=0,t=n.length;k<t;k++){u.stopObserving(n[k]);n[k]=null}}function f(k,t,r){k=$(k);if(k===document&&t=="dom:loaded"){if(typeof Weebly!=="undefined"&&Weebly.ready){var v=r;r=function(){Weebly.ready(function(){v.call(document)})}}if(document.loaded){r.call(document);
...
/*
     FILE ARCHIVED ON 06:50:02 Aug 14, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:51:29 Aug 30, 2022.
...
/*
playback timings (ms):
  captures_list: 3715.994
  exclusion.robots: 0.076
  exclusion.robots.policy: 0.069
  cdx.remote: 0.055
  esindex: 0.01
  LoadShardBlock: 114.393 (3)
  PetaboxLoader3.datanode: 128.225 (5)
  CDXLines.iter: 29.947 (3)
  load_resource: 208.088 (2)
  PetaboxLoader3.resolve: 102.055 (2)
*/